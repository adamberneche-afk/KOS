/**
 * cas-ccps:master-student-template's deploy-version marker + trigger (process-hardening sprint
 ...
 * `node tools/deploy-drift/stamp.js cas-ccps:master-student-template`.
 *
