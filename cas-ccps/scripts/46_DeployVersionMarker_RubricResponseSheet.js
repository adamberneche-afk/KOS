 ...
 *   4. node tools/clasp-sync/sync.js rubric-response-sheet, then clasp push + clasp
 *      deploy from cas-ccps/.clasp-build/rubric-response-sheet/ to actually promote it
