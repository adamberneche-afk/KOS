/**
 * cas-ccps:rubric-response-sheet's deploy-version marker + trigger (process-hardening sprint
 ...
 * `node tools/deploy-drift/stamp.js cas-ccps:rubric-response-sheet`.
 *
 * NEVER hand-edit DEPLOY_VERSION_SHA. Always:
 *   1. Commit your real rubric-response-sheet code change(s) normally.
 *   2. node tools/deploy-drift/stamp.js cas-ccps:rubric-response-sheet
 *   3. Commit ONLY the resulting change to this file, by itself.
 *   4. node tools/clasp-sync/sync.js rubric-response-sheet, then clasp push from
 *      cas-ccps/.clasp-build/rubric-response-sheet/ (tools/clasp-sync/DEPLOYMENT_RUNBOOK.md
...
function reportDeployVersion() {
  return _reportDeployVersion_('cas-ccps:rubric-response-sheet', DEPLOY_VERSION_SHA);
}
