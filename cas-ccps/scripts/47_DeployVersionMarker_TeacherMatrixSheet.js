/**
 * cas-ccps:teacher-matrix-sheet's deploy-version marker + trigger (process-hardening sprint
 ...
 * `node tools/deploy-drift/stamp.js cas-ccps:teacher-matrix-sheet`.
 *
 * NEVER hand-edit DEPLOY_VERSION_SHA. Always:
 *   1. Commit your real teacher-matrix-sheet code change(s) normally.
 *   2. node tools/deploy-drift/stamp.js cas-ccps:teacher-matrix-sheet
 *   3. Commit ONLY the resulting change to this file, by itself.
 *   4. node tools/clasp-sync/sync.js teacher-matrix-sheet, then clasp push from
 *      cas-ccps/.clasp-build/teacher-matrix-sheet/ (tools/clasp-sync/DEPLOYMENT_RUNBOOK.md
...
function reportDeployVersion() {
  return _reportDeployVersion_('cas-ccps:teacher-matrix-sheet', DEPLOY_VERSION_SHA);
}
