...
> (`tests/`, `npm test`, 329 passing at the time of writing — run `npm test`
...
runs under `npm test` (329 passing at the time of writing) with real
...
> actual `.gs`/`.js` source via `tests/harness/gas-sandbox.js` — 329
